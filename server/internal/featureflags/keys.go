...
const (
	...
	// MarketplaceV1 gates the instance-local discovery catalog. Plugin entries
	// additionally require PluginsV1 so the market cannot reveal a disabled asset
	// type through a second switch.
